...
{
    /// <summary>
    ///  The class implements the IRowSortingType interface and sets the priority of rows in ascending order of max elements.
    /// </summary>
    public class SortingByMaxElementsInAscendingOrder : IRowSortingType
    {
        /// <summary>
