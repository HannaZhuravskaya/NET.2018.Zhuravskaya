...
{
    /// <summary>
    /// The class implements the IRowSortingType interface and sets the priority of rows in descending order of element sums.
    /// </summary>
    public class SortingBySumOfElementsInDescendingOrder : IRowSortingType
    {
        /// <summary>
